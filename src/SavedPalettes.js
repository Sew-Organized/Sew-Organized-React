...
export default class SavedPalettes extends Component {
    ...
    render() {
        ...
        console.log('saved palettes in state', this.state.savedPalettes)
        const savedPaletteArray = this.state.savedPalettes.map(palette => {
            console.log('palette in map', palette)
            return [palette.palette_name, palette.dmc_one, palette.dmc_two, palette.dmc_three, palette.dmc_four, palette.dmc_five];
        })
